...
void Menu::Menu_update(sf::RenderWindow &c_window, float deltaTime)
{
    ...
    if (c_menuState.currentState != lastAnimationState)
    {
        ...
        if (c_menuState.currentState == MenuState::MainMenu)
        {
            ...
            currentAnimations.push_back(AnimatedText(&MainMenu_StartText, {startX, 450.f}, {150.f, 450.f}, 0.1f));
            currentAnimations.push_back(AnimatedText(&MainMenu_SettingText, {startX, 550.f}, {150.f, 550.f}, 0.2f));
            currentAnimations.push_back(AnimatedText(&MainMenu_ExitText, {startX, 650.f}, {150.f, 650.f}, 0.3f));
        }
        else if (c_menuState.currentState == MenuState::Setting)
        {
            titleText.setPosition({150.f, 100.f});
            currentAnimations.push_back(AnimatedText(&Setting_VolumeText, {startX, 300.f}, {150.f, 300.f}, 0.1f));
            currentAnimations.push_back(AnimatedText(&Setting_isFullScreenText, {startX, 380.f}, {150.f, 380.f}, 0.15f));
            currentAnimations.push_back(AnimatedText(&Setting_frameRateText, {startX, 460.f}, {150.f, 460.f}, 0.2f));
            currentAnimations.push_back(AnimatedText(&Setting_isSwayText, {startX, 540.f}, {150.f, 540.f}, 0.25f));
            currentAnimations.push_back(AnimatedText(&Setting_isMouseleaveText, {startX, 620.f}, {150.f, 620.f}, 0.3f));
            currentAnimations.push_back(AnimatedText(&Setting_isMousefollowText, {startX, 700.f}, {150.f, 700.f}, 0.35f));
            currentAnimations.push_back(AnimatedText(&Setting_isSkipBeginText, {startX, 780.f}, {150.f, 780.f}, 0.4f));
            currentAnimations.push_back(AnimatedText(&Setting_BackText, {startX, 860.f}, {150.f, 860.f}, 0.45f));
        }
        else if (c_menuState.currentState == MenuState::Pause)
        {
            titleText.setPosition({150.f, 100.f});
            currentAnimations.push_back(AnimatedText(&Pause_ResumeText, {startX, 450.f}, {150.f, 450.f}, 0.1f));
            currentAnimations.push_back(AnimatedText(&Pause_SettingText, {startX, 550.f}, {150.f, 550.f}, 0.2f));
            currentAnimations.push_back(AnimatedText(&Pause_ExitText, {startX, 650.f}, {150.f, 650.f}, 0.3f));
        }
        else if (c_menuState.currentState == MenuState::Over)
        {
            titleText.setPosition({150.f, 100.f});
            currentAnimations.push_back(AnimatedText(&Over_RestartText, {startX, 450.f}, {150.f, 450.f}, 0.1f));
            currentAnimations.push_back(AnimatedText(&Over_ExitText, {startX, 550.f}, {150.f, 550.f}, 0.2f));
        }
        else if (c_menuState.currentState == MenuState::Win)
        {
            titleText.setPosition({150.f, 100.f});
            currentAnimations.push_back(AnimatedText(&Win_RestartText, {startX, 450.f}, {150.f, 450.f}, 0.1f));
            currentAnimations.push_back(AnimatedText(&Win_ExitText, {startX, 550.f}, {150.f, 550.f}, 0.2f));
        }
    }
