/*
 *@文件 ： CorridorWithNoToiletBoyDoor.hpp
 *@描述 ： 男厕所门消失异常
 *@作者 ： 逍遥风鉴事
 *@时间 ： 2026-2-15
 */
...
class CorridorWithNoToiletBoyDoor : public Abnormity
{
public:
private:
...
public:
    ...
    CorridorWithNoToiletBoyDoor(Scene *scene) : Abnormity(scene),
                                                background_texture("game_main/picture/wrong/23.png"),
    ...
    bool HandleEvent_Corridor_ontoiletman(const sf::Event::KeyPressed &key) override
    {
