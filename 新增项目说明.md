## 2月23日SED
### 修正
1.修复了设置界面无法调整是否鼠标跟随的问题
### 调整
1.现在角色文字居中显示
### 新增
1.新增了菜单异常
2.追加了带deltatime的update函数

## 2月22日
### 修正
1.修复了部分由于析构函数导致的崩溃问题  
2.修复了游戏结算位置错误问题  
3.修复了游戏暂停界面返回主界面错位问题  
4.修复了游戏通关后再次进入游戏时钟显示错误的问题  
5.修复了最后一关也能出现异常的问题  
6.修复了摄像机可以看见左右贴图外黑边问题  
7.去除了未完成异常随机导致异常重复的问题  
### 新增
1.新增了文字动画效果  
2.新增视角晃动和鼠标跟随
...
1. 增加了22个异常（待实现3个）  
### 特别说明
由于代码目前逻辑问题，在异常中无法直接实现游戏结束，故第15、18号异常仅提示对话，没有游戏结束；      
第10、16、17、19、20号异常保留了原交互方式，没有更新。    
第18号异常，若回头会直接回到起点。     
第2、12、13、14号异常未制作完毕，暂时用1号异常代替。    
现在更改角色速度时也需要在`PlayerSpeedWrong.hpp`更改一份。  
...
2. 添加了一个异常
### 便利调试说明
如果觉得角色走得慢，可以在`player/player.cpp`第16行修改speed    
